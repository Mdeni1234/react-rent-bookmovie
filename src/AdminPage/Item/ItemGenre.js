...
const ItemGenre = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (response.data.message === "Genre already exist in this item")
  ...
  const handleDelete = async (genre_id) => {
    try {
      await axios.delete(`${urlGateway}/item/${id}/set-genre`, {
        headers: { Authorization: `Bearer ${user.token}` },
        data: { genre_id },
      });
          ...
          >
            <Col span={8}>
              <Divider orientation="left">
                <span style={{ color: "white" }}> Item Info</span>
              </Divider>
              <Descriptions
                bordered
                column={1}
              ...
              >
                ...
                <Descriptions.Item label="Author/Director">
                  <span style={{ color: "white" }}> {item.creator}</span>
                </Descriptions.Item>
              ...
              <Divider orientation="left" plain>
                {" "}
                <span style={{ color: "white" }}> Add Genre</span>
              </Divider>
              <Form
                form={form}
                style={{
